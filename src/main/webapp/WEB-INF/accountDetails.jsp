            ...
            <c:otherwise>
              ...
              <c:forEach var="o" items="${orderList}">
                <tr>
                  ...
                  <td class="cart_total">
                    <%
                      com.Songzhiyong.model.Order o = (com.Songzhiyong.model.Order) pageContext.findAttribute("o");
                      int n = o.getPaymentId();
                      java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                      String paymentType = com.Songzhiyong.model.Payment.findByPaymentId(con, n);
                    %>
